            ...
            '.ke-script, .ke-noscript, .ke-display-none {',
              ...
              function _lang(mixed, langType) {
                ...
                _each(mixed, function(key, val) {
                  ...
                  _language[langType][obj.ns][obj.key] = val; }); } function _getImageFromRange(range, fn) { if (range.collapsed) { return; } range = range.cloneRange().up(); var sc = range.startContainer, so = range.startOffset;
